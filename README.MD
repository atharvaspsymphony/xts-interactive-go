...
### Hostlookup
call the Hostlookup API to get the connectionstring, this step is for load balancing
POST /hostlookup
```go
...
response, err := Hostlookup(hostlookupPayload)
```
once hostlookup step is done, you can call login
